  ...
  return (
    <div className="sidebarOptions">
      <div className="sidebarOption">
        ...
        <p className="optionText" style={{color: '#0d8ecf',fontWeight: 'bold'}}>Placements<br/>Reviews</p>

        <img src="https://cdn-icons-png.flaticon.com/512/4658/4658825.png" alt="Loading" className="feedbackicon" />
        <p className="optionText" style={{color:'#0d8ecf',fontWeight: 'bold' }}>Course<br/>Feedback</p>

        <img src="https://static.thenounproject.com/png/472944-200.png" alt="Loading" className="reviewicon" />
        <p className="optionText" style={{color:'#0d8ecf',fontWeight: 'bold'}}>Hostel<br/>Review</p>
        ...
        <p className="optionText" style={{color:'#0d8ecf',fontWeight: 'bold'}}>College<br/>Infrastructure</p>

        <img src="https://cdn-icons-png.flaticon.com/512/8/8178.png" alt="Loading" className="locationicon" />
        <p className="optionText" style={{color:'#0d8ecf',fontWeight: 'bold'}}>College<br/>Location</p>
        ...
        <p className="optionText" style={{color:'#0d8ecf',fontWeight: 'bold'}}>Sports<br/>Facilities</p>

        <img src="https://cdn-icons-png.flaticon.com/512/6926/6926264.png" alt="Loading" className="scholarshipicon" />
        <p className="optionText" style={{color: '#0d8ecf',fontWeight: 'bold'}}>Various<br/>Scholarships</p>
        ...
        <p className="optionText" style={{color:'#0d8ecf',fontWeight: 'bold'}}>Fee<br/>Structure</p>
      </div>
    </div>
  );
}
