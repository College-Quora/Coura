        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", backgroundColor: "#fff", padding: "50px", borderRadius: "10px", boxShadow: "3px 4px 4px rgba(0, 0, 0, 0.25)" }}>
          {validUrl ? (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              <h2 style={{ color: "#333333", marginBottom: "35px", fontSize: "50px" }}>Reset Password</h2>
              <label htmlFor="password" style={{ color: "#333333", display: "block", marginBottom: "10px", fontSize: "20px", fontWeight:"bold" }}>Enter The New Password:</label>
              ...
              <label htmlFor="confirmpassword" style={{ color: "#333333", display: "block", marginBottom: "10px", fontSize: "20px" , fontWeight:"bold"}}>Confirm New Password:</label>
              <input value={confirmPass} onChange={(e) => setConfirmPass(e.target.value.trim())} type="password" placeholder="********" id="password" name="password" style={{ padding: "10px", borderRadius: "5px", border: "1px solid #1E90FF", marginBottom: "20px" }} />
      
              <button className="link-btn" onClick={handleResetPassword} style={{ backgroundColor: "#0d8ecf", color: "#fff", padding: "10px", borderRadius: "5px", border: "none", cursor: "pointer", marginLeft: "15px" }}>Submit</button>
            </div>
          ) : (
